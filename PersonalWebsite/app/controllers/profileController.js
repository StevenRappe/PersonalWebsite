app.controller('profileController', function($scope) {
	//$scope.homePageTest="home works";

	//row 1
		//col1
	$scope.intro1="I am a Software Developer who specializes in front end and UI/UX web development, but I also have experience working as a full stack developer.";
	$scope.intro2="Currently, I work as a developer for FedEx in mulitple roles, as a front end and full stack developer on two respective systems, and as an offshore team lead."
	...
	$scope.bio2="Recently I have become very interested in cryptocurrecnies, and blockchain technology in general. The advantages blockchain provides in transaction speed, security, and decentralization may prove to revoluntionize financial services, data storage, and many other industries.";
